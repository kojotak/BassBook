...
public class BassbookDatabase {
    ...
    private List<Author> prepareAuthors(){
        return orderedList(
                ...
                new Author("Nina Simone", orderedList(name("Feeling good").youtube(HARRY, "qs9KVyJnKIU"))),
                ...
                new Author("Talking heads", orderedList(name("Psycho killer").youtubeAnd(HARRY, "SNZHCz4rzKA").youtubeAnd(NOCCO_CAT, "m32-etMoOMY", of(STACCATO)).youtube(COVERSOLUTIONS, "6NpufkkmNmo"))),
                new Author("The White stripes", orderedList(name("Seven nation army").youtubeAnd(HARRY, "6_7VrkrUuKc").youtube(ANDRE_CARVALHO, "adrcarvalho93"))),
                new Author("The Black eyed peas", orderedList(name("Let's get it started").youtube(HARRY, "iz89AiRQhE0"))),
                new Author("Sia", orderedList(name("Snowman").meter(6, 8).youtube(NOCCO_CAT, "KSye_cosGI4"))),
                ...
                new Author("The Prodigy", orderedList(name("Climbatize").youtube(CARLOS_CARLESI, "dqR-t46ZtdA"))),
                ...
                new Author("Coldplay", orderedList(name("Yellow").youtube(EUBASS, "hTnGMOT76lk", of(SLIDE)))),
                new Author("System of a Down", orderedList(name("Toxicity").meter(6, 8).youtubeAnd(EUBASS, "fORp9OK7wys", CGCF).youtube(COVERSOLUTIONS, "G_3Aze81cf0", CGCF))),
                new Author("Gorillaz", orderedList(name("Feel Good Inc.").youtube(NOCCO_CAT, "g4pCrlkUUn4", EbAbDbGb))),
                new Author("Lenny Kravitz", orderedList(name("Honey").youtube(NOCCO_CAT, "P-aXqEShNwA"))),
                new Author("Al Green", orderedList(name("Let's Stay Together").youtube(NOCCO_CAT, "75Me-AY6Ia8"))),
                new Author("Sheryl Crow", orderedList(name("Tomorrow never dies").meter(12, 8).youtube(NOCCO_CAT, "ffECgN2Mtjk"))),
