...
public class BassbookDatabase implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private Author cranberries() {
        return new Author("The Cranberries", List.of(
    ...
    @Bean
    private Author rem() {
        return new Author("R.E.M", List.of(
    ...
    @Bean
    private Author rhcp() {
        return new Author("Red hot chilli peppers", List.of(
    ...
    @Bean
    private Author muse() {
        return new Author("Muse", List.of(
    ...
    private Author philCollins() {
        return new Author("Phil Collins", List.of(
    ...
    private Author queen() {
        return new Author("Queen", List.of(
    ...
    private Author talkingHeads() {
        return new Author("Talking heads", List.of(
    ...
    private Author adele() {
        return new Author("Adele", List.of(
    ...
    private Author coldplay() {
        return new Author("Coldplay", List.of(
                name("Yellow").youtube(EUBASS, "hTnGMOT76lk", of(SLIDE))));
    }

    @Bean
    private Author systemOfADown() {
        return new Author("System of a Down", List.of(
    ...
    @Bean
    private Author toto() {
        return new Author("Toto", List.of(
    ...
    private Author linkinPark() {
        return new Author("Linkin Park", List.of(
                name("Heavy Is The Crown").youtube(COVERSOLUTIONS, "IhIiZl7ZOk4")));
    }

    @Bean
    private Author acdc() {
        return new Author("AC/DC", List.of(
    ...
    private Author oneRepublic() {
        return new Author("One Republic", List.of(
                name("Counting Stars").youtube(BRAND73, "kHbfIXcO9Bs")));
    }

    @Bean
    private Author fleetwoodMac() {
        return new Author("Fleetwood Mac", List.of(
    ...
    @Bean
    private Author ratm() {
        return new Author("Rage against the machine", List.of(
    ...
    private Author metallica() {
        return new Author("Metallica", List.of(
    ...
    private Author sting() {
        return new Author("Sting", List.of(
    ...
    private Author deftones() {
        return new Author("Deftones", List.of(
    ...
    private Author boneyM() {
        return new Author("Boney M", List.of(
                name("Rasputin").youtube(COVERSOLUTIONS, "XdGQoq7PzVk")));
    }

    @Bean
    private Author sade() {
        return new Author("Sade", List.of(
    ...
    private Author kateBush() {
        return new Author("Kate Bush", List.of(
